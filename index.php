  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
	    ...
	    <li><a href="#our-team" class="page-scroll">Analisis</a></li>
   ...
   <div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="3000" data-pause="false">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/slide1.jpg" alt="w3layouts" class="img-responsive">
			</div>
			<div class="item">
				<img src="images/slide2.jpg" alt="w3layouts" class="img-responsive">
			</div>
			<div class="item">
				<img src="images/slide3.jpg" alt="w3layouts" class="img-responsive">
			</div>
		</div>
		...
		<div class="about-us-agileits-info">
			<div class="container">
				<div class="row">
					...
					<iframe width="560" height="315" src="https://www.youtube.com/embed/h7PIsY4gOnQ?si=kenZoaufY4BTAqW8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
					</div>
...
<div class="our-team-w3l" style="background-color: darkred;color: white;" id="our-team">
	...
	<h3>Sistem Pakar Panduan Studi</h3>
	</div>
...
<div class="locations-w3-agile" id="locations">
	...
	<div class="gallery_product-w3-agile col-lg-4 col-md-4 col-sm-4 col-xs-6">
		<div class="hovereffect">
			<a class="chocolat-image"  href="images/untag1.jpg"><img src="images/untag1.jpg" class="img-responsive" alt=" ">
				<div class="overlay">
					<h4>Universitas 17 Agustus 1945 Surabaya</h4>
					<p>Denah Untag tampak drone.</p>
				</div>
			</a>
		</div>
	</div>
	...
	<div class="gallery_product-w3-agile col-lg-4 col-md-4 col-sm-4 col-xs-6">
		<div class="hovereffect">
			<a class="chocolat-image" href="images/untag2.jpg"><img src="images/untag2.jpg" class="img-responsive" alt=" ">
				<div class="overlay">
					<h4>profil</h4>
					<p>Untag mode cerah.</p>
				</div>
			</a>
		</div>	
	</div>
	...
	<div class="gallery_product-w3-agile col-lg-4 col-md-4 col-sm-4 col-xs-6">
	<div class="hovereffect">
        <a class="chocolat-image" href="images/untag3.jpg"><img src="images/untag3.jpg" class="img-responsive" alt=" ">
			<div class="overlay">
				<h4>Universitas 17 Agustus 1945 Surabaya</h4>
				<p>Untag mode hujan.</p>
			</div>
		</a>
		</div>		
    </div>
